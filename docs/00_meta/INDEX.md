...
| `合规专项调研.md` | active | **上线前必读**。《拟人化互动服务管理暂行办法》逐条对照 + 声音权/个保法 + R1–R15 风险清单 + A/B 两级上线门槛。回答 `SPEC.md` §12.2 的三个「未获取」项 |
...
| **上线前必须做什么合规** | `05_research/合规专项调研.md` §七（R1–R15 风险清单 + A/B 两级门槛） |
| **能不能做真人声音模仿** | `05_research/合规专项调研.md` §五（声音权，可识别性标准） |
| **投料他人素材要注意什么** | `05_research/合规专项调研.md` §六（敏感个人信息 + 单独同意） |
